resource "aws_instance" "obligatorio_frontend" {
  ...
  provisioner "remote-exec" {
    ...
    inline = [
      ...
      # "cd /home/ec2-user/deployments2023/redis",
      # "docker build -t mauropillox/redisobligatorio:latest .",
      # "docker push mauropillox/redisobligatorio:latest",
      ...
      "sudo -u ec2-user docker rmi mauropillox/currencyserviceobligatorio:latest",
      "sudo -u ec2-user docker rmi mauropillox/emailserviceobligatorio:latest",
      "sudo -u ec2-user docker rmi mauropillox/paymentserviceobligatorio:latest",
      "sudo -u ec2-user docker rmi mauropillox/productcatalogserviceobligatorio:latest",
